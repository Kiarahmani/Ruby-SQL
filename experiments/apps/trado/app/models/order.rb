...
class Order < ActiveRecord::Base
  ...
  def count_per_month(*args); where; end
  def self.count_per_month(*args); where; end
  def last_transaction_collection(*args); where; end
  def self.last_transaction_collection(*args); where; end
  def pending_collection(*args); where; end
  def self.pending_collection(*args); where; end
  def completed_collection(*args); where; end
  def self.completed_collection(*args); where; end
  def failed_collection(*args); where; end
  def self.failed_collection(*args); where; end
  def gross_total(*args); where; end
  def self.gross_total(*args); where; end
  def net_total(*args); where; end
  def self.net_total(*args); where; end
  def tax_total(*args); where; end
  def self.tax_total(*args); where; end
  def paypal(*args); where; end
  def self.paypal(*args); where; end

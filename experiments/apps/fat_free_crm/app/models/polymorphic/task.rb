...
class Task < ActiveRecord::Base
  ...
  def my(*args); where; end
  def self.my(*args); where; end
  def created_by(*args); where; end
  def self.created_by(*args); where; end
  def assigned_to(*args); where; end
  def self.assigned_to(*args); where; end
  def assigned_by(*args); where; end
  def self.assigned_by(*args); where; end
  def tracked_by(*args); where; end
  def self.tracked_by(*args); where; end
  def visible_on_dashboard(*args); where; end
  def self.visible_on_dashboard(*args); where; end
  def by_due_at(*args); where; end
  def self.by_due_at(*args); where; end
  def pending(*args); where; end
  def self.pending(*args); where; end
  def assigned(*args); where; end
  def self.assigned(*args); where; end
  def completed(*args); where; end
  def self.completed(*args); where; end
  def due_asap(*args); where; end
  def self.due_asap(*args); where; end
  def overdue(*args); where; end
  def self.overdue(*args); where; end
  def due_today(*args); where; end
  def self.due_today(*args); where; end
  def due_tomorrow(*args); where; end
  def self.due_tomorrow(*args); where; end
  def due_this_week(*args); where; end
  def self.due_this_week(*args); where; end
  def due_next_week(*args); where; end
  def self.due_next_week(*args); where; end
  def due_later(*args); where; end
  def self.due_later(*args); where; end
  def completed_today(*args); where; end
  def self.completed_today(*args); where; end
  def completed_yesterday(*args); where; end
  def self.completed_yesterday(*args); where; end
  def completed_this_week(*args); where; end
  def self.completed_this_week(*args); where; end
  def completed_last_week(*args); where; end
  def self.completed_last_week(*args); where; end
  def completed_this_month(*args); where; end
  def self.completed_this_month(*args); where; end
  def completed_last_week(*args); where; end
  def self.completed_last_week(*args); where; end
  def text_search(*args); where; end
  def self.text_search(*args); where; end

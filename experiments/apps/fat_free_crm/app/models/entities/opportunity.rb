...
class Opportunity < ActiveRecord::Base
  ...
  def state(*args); where; end
  def self.state(*args); where; end
  ...
  def won(*args); where; end
  def self.won(*args); where; end
  def lost(*args); where; end
  def self.lost(*args); where; end
  def not_lost(*args); where; end
  def self.not_lost(*args); where; end
  def pipeline(*args); where; end
  def self.pipeline(*args); where; end
  def unassigned(*args); where; end
  def self.unassigned(*args); where; end
  ...
  def by_closes_on(*args); where; end
  def self.by_closes_on(*args); where; end
  def by_amount(*args); where; end
  def self.by_amount(*args); where; end
